    ...
    <div class="level-container">
        ...
        <div class="level-content">
            ...
            <div class="intro-section">
                ...
                <p style="margin-top: 20px; color: #666;">Read the modules below, then complete the assessment. You need 80% to pass and unlock Level 7.</p>
            </div>
            ...
            <form method="POST" action="" id="quizForm" class="quiz-form">
                ...
                <div class="question-card" data-question="6">
                    ...
                    <h3>What is misinformation?</h3>
                    <p class="hint">Hint: False info, not always shared on purpose.</p>
                ...
                <div class="question-card" data-question="7">
                    ...
                    <p class="hint">Hint: Fact-checking, verifying sources...</p>
                ...
                <div class="question-card" data-question="8">
                    ...
                    <p class="hint">Hint: Credible, verified, trustworthy...</p>
                ...
                <div class="question-card" data-question="9">
                    ...
                    <p class="hint">Hint: Panic, confusion, distrust...</p>
                ...
                <div class="question-card" data-question="10">
                    ...
                    <p class="hint">Hint: Verify it first.</p>
