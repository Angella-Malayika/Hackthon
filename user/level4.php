    ...
    <div class="level-container">
        ...
        <div class="level-content">
            ...
            <div class="intro-section">
                ...
                <p style="margin-top: 20px; color: #666;">Read the modules below, then complete the assessment. You need 80% to pass and unlock Level 5.</p>
            </div>
            ...
            <form method="POST" action="" id="quizForm" class="quiz-form">
                ...
                <div class="question-card" data-question="6">
                    ...
                    <p class="hint">Hint: Think about protecting systems and data.</p>
                ...
                <div class="question-card" data-question="7">
                    ...
                    <p class="hint">Hint: Malware, phishing, ransomware...</p>
                ...
                <div class="question-card" data-question="8">
                    ...
                    <p class="hint">Hint: Length and complexity.</p>
                ...
                <div class="question-card" data-question="9">
                    ...
                    <p class="hint">Hint: An extra layer of security.</p>
                ...
                <div class="question-card" data-question="10">
                    ...
                    <p class="hint">Hint: Updates, antivirus, strong passwords...</p>
